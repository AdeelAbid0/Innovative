...
const CaseStudyModal: React.FC<CaseStudyModalProps> = memo(
  ({ caseStudy, onClose }) => {
    return (
      <div
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {caseStudy.results.metrics.map((metric, index) => (
                  <Card
                    key={index}
                    className="p-4 text-center bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10"
                  >
