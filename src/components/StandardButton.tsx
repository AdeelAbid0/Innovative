...
export function StandardButton({
  ...
  const baseStyles =
    "relative overflow-hidden transition-all duration-300 ease-out transform hover:scale-[1.02] active:scale-[0.98] rounded-[99px]";
  ...
  const variantStyles = {
    ...
    outline:
      "bg-transparent border-2 border-white text-white hover:bg-white/10 shadow-[0px_2px_8px_0px_rgba(255,255,255,0.2)]",
    secondary:
      "bg-primary/10 text-primary border-2 border-primary/30 hover:bg-primary/20 shadow-[0px_4px_12px_0px_rgba(12,218,32,0.3)]",
