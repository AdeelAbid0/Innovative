    ...
    <>
      <div className="min-h-screen bg-background">
        ...
        <section
          ...
          id="home"
          className={`min-h-screen flex items-center justify-center bg-background relative pt-0 md:pt-0 section-reveal snap-start ${heroAnimation.isVisible ? 'visible' : ''}`}
        >
        ...
        <section
          ...
          id="services"
          className={`min-h-screen flex flex-col justify-center bg-muted/30 section-reveal snap-start ${servicesAnimation.isVisible ? 'visible' : ''}`}
        >
        ...
        <section
          ...
          id="work"
          className={`min-h-screen flex flex-col justify-center  bg-muted/20 section-reveal snap-start ${workAnimation.isVisible ? 'visible' : ''}`}
        >
          <div className="max-w-7xl mx-auto px-6 pt-6">
        ...
        <section
          ...
          id="about"
          className={`min-h-screen flex flex-col justify-center bg-background section-reveal snap-start ${aboutAnimation.isVisible ? 'visible' : ''}`}
        >
          <div className="max-w-7xl mx-auto px-6 pt-6">
        ...
        <section
          ...
          id="contact"
          className={`bg-muted/30 section-reveal snap-start ${contactAnimation.isVisible ? 'visible' : ''}`}
        >
          <div className="max-w-7xl mx-auto px-6 pt-6">
      ...
      {/* Footer - Full Width at Bottom, After Contact Section */}
      <div style={{ marginTop: "100px" }}>
        <Footer onNavigate={(page) => onNavigate(page as Page)} />
      </div>    </>
  );
}