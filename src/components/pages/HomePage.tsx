...
// Import coding effect components
...
function TypewriterText() {
  ...
  return (
    <span className="inline-block text-primary px-8 py-2 border-2 border-primary/30 rounded-xl bg-primary/5 mx-4 typewriter-glow relative">
      {displayText}
...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const servicesCardsAnimation = useStaggeredAnimation(3, {
    threshold: 0.2,
    triggerOnce: true,
  });
  const aboutStatsAnimation = useStaggeredAnimation(4, {
    threshold: 0.2,
    triggerOnce: true,
  });
  const missionVisionAnimation = useStaggeredAnimation(2, {
    threshold: 0.2,
    triggerOnce: true,
  });
  ...
  const caseStudies = [
    {
      ...
      industry: "E-Commerce",
      challenge:
        "Outdated infrastructure, slow load times, poor mobile experience causing high cart abandonment rates.",
      solution:
        "Modern microservices architecture with advanced caching, CDN implementation, and mobile-first responsive design.",
      results: {
        metrics: [
        ...
        quote:
          "Sales increased by 150% within the first quarter after launch. The new platform exceeded all our expectations.",
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge:
        "Streamline patient management and improve healthcare provider communication while ensuring HIPAA compliance.",
      solution:
        "Comprehensive healthcare management system with secure patient portals, telemedicine capabilities, and automated workflows.",
      results: {
        metrics: [
        ...
        quote:
          "Efficiency improved dramatically while maintaining the highest standards of patient care and data security.",
    ...
    },
    {
      ...
      challenge:
        "Modernize legacy banking systems and implement real-time fraud detection while maintaining regulatory compliance.",
      solution:
        "AI-powered fraud detection system with real-time processing, intuitive mobile banking app, and seamless API integrations.",
      results: {
        metrics: [
        ...
        quote:
          "Fraud incidents dropped by 90% and customer engagement increased dramatically. This transformed our business.",
        author: "James Wilson",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append("access_key", "bf13d757-c021-4049-aab5-608c3b82355a");
    try {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        id="home"
        className={`min-h-screen flex items-center justify-center bg-background relative pt-20 md:pt-24 section-reveal overflow-hidden ${
          heroAnimation.isVisible ? "visible" : ""
        }`}
      >
        {/* Enhanced Coding Background Effects - Keep on all devices */}
        <EnhancedCodingEffects />
        <CodeTerminal />

        <div className="absolute inset-0 bg-gradient-to-br from-background via-background to-primary/5 opacity-30 z-[1]"></div>

        <div
          className={`max-w-6xl mx-auto px-6 text-center relative z-20 stagger-children ${
            heroAnimation.isVisible ? "animate" : ""
          }`}
        >
          {/* Badge - Hidden on Mobile, Visible on Desktop */}
          <div className="hidden md:inline-flex items-center gap-2 bg-primary/20 text-primary px-4 py-2 rounded-full text-sm font-medium mb-8 scroll-animate-badge">
            <Zap className="w-4 h-4" />
            Software Development Company
          </div>

          <h1 className="text-hero bebas-neue-regular text-foreground mb-6 md:mb-8 max-w-4xl mx-auto text-center leading-tight mobile-hero-title">
            We Build Powerful
            <br />
            <TypewriterText />
            <br />
          ...
          <p className="text-base md:text-xl text-muted-foreground mb-10 md:mb-12 max-w-3xl mx-auto text-center leading-relaxed mobile-hero-subtitle">
            Transform your ideas into reality with custom software solutions. We
            specialize in building scalable, secure, and innovative technology.
          </p>
          ...
          <Button
            ...
            className="bg-primary hover:bg-primary/90 text-black hover:text-black px-8 py-3 text-lg hover:scale-105 transition-all duration-300 hero-cta-button font-semibold"
          >
            Get Free Quotations
          </Button>
        </div>
      ...
      <section
        ...
        className={`py-20 bg-muted/30 section-reveal ${
          servicesAnimation.isVisible ? "visible" : ""
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`text-center mb-16 stagger-children ${
              servicesAnimation.isVisible ? "animate" : ""
            }`}
          >
          ...
          <div
            ...
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-children ${
              servicesCardsAnimation.isVisible ? "animate" : ""
            }`}
          >
            {services.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className={`relative overflow-hidden bg-card border border-white/10 hover:border-primary/30 transition-all duration-300 hover:scale-[1.02] group scroll-animate-card ${
      ...
      <section
        ...
        id="work"
        className={`py-20 bg-muted/20 section-reveal ${
          workAnimation.isVisible ? "visible" : ""
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`text-center mb-16 stagger-children ${
              workAnimation.isVisible ? "animate" : ""
            }`}
          >
            <Badge className="bg-primary/20 text-primary border-primary/30 mb-6 px-4 py-2 scroll-animate-badge">
          ...
          <div
            ...
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 stagger-children ${
              caseStudiesAnimation.isVisible ? "animate" : ""
            }`}
          >
            {caseStudies.map((caseStudy, index) => {
              ...
              return (
                <Card
                  ...
                  className={`group cursor-pointer overflow-hidden bg-card border border-white/10 hover:border-primary/30 transition-all duration-300 hover:shadow-2xl scroll-animate-card ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-8"
                  }`}
      ...
      <section
        ...
        className={`py-20 bg-background section-reveal ${
          aboutAnimation.isVisible ? "visible" : ""
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`text-center mb-16 stagger-children ${
              aboutAnimation.isVisible ? "animate" : ""
            }`}
          >
            <Badge className="bg-primary/20 text-primary border-primary/30 mb-6 px-4 py-2 scroll-animate-badge">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              innovators dedicated to transforming ideas into powerful digital
              solutions.
            </p>
          </div>
          ...
          <div
            ...
            className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 stagger-children ${
              aboutStatsAnimation.isVisible ? "animate" : ""
            }`}
          >
            {[
              { number: "100+", label: "Projects delivered", icon: Briefcase },
              { number: "55+", label: "Happy Clients", icon: Users },
              { number: "10+", label: "Years of experience", icon: TrendingUp },
              { number: "92%", label: "Customer satisfaction", icon: Star },
            ].map((stat, index) => {
              ...
              return (
                <Card
                  key={index}
                  className={`p-6 text-center bg-card border border-white/10 hover:border-primary/30 transition-all duration-300 scroll-animate-card ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-8"
                  }`}
          ...
          <div
            ...
            className={`grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 stagger-children ${
              missionVisionAnimation.isVisible ? "animate" : ""
            }`}
          >
            <Card
              className={`p-8 bg-card border border-white/10 hover:border-primary/30 transition-all duration-300 scroll-animate-card ${
                missionVisionAnimation.visibleItems[0]
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            >
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  bridge the gap between complex technology and practical
                  business needs.
                </p>
              </CardContent>
            </Card>
            ...
            <Card
              className={`p-8 bg-card border border-white/10 hover:border-primary/30 transition-all duration-300 scroll-animate-card ${
                missionVisionAnimation.visibleItems[1]
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            >
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To be the leading software development partner that businesses
                  trust for their most critical projects. We envision a future
                  where technology seamlessly integrates with business
                  processes.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="rounded-2xl p-8 md:p-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                {
                  name: ".NET, Node.js & Python",
                  icon: Settings,
                  description: "Powerful backend technologies",
                },
                {
                ...
                },
                {
                  ...
                  icon: Briefcase,
                  description: "Business-grade systems",
                },
                {
                  name: "DevOps & CI/CD",
                  icon: TrendingUp,
                  ...
                  >
                    <CardContent className="p-6 space-y-4">
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 glow-effect-radial"></div>
                      </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`text-center mb-16 stagger-children ${
              contactAnimation.isVisible ? "animate" : ""
            }`}
          >
            <Badge className="bg-primary/20 text-primary border-primary/30 mb-6 px-4 py-2 scroll-animate-badge">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Form */}
            <div className="bg-background flex items-end justify-center">
              <Card className="border border-white/10 bg-card w-full">
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        required
                        rows={12}
                        className="bg-background/50 border-white/10 focus:border-primary resize-none min-h-[250px]"
