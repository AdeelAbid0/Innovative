...
export function ServicesPage({ onNavigate }: ServicesPageProps) {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Intelligent solutions that leverage AI and ML to transform your business processes.",
      features: [
    ...
    },
    {
      ...
      description:
        "Scalable cloud infrastructure and DevOps solutions to power your applications.",
      features: [
    ...
    },
    {
      ...
      description:
        "Robust, secure systems designed to handle complex business operations at scale.",
      features: [
  ...
  const process = [
    {
      ...
      description:
        "We analyze your requirements, define project scope, and create a comprehensive strategy.",
      icon: Search,
      duration: "1-2 weeks",
      deliverables: [
    ...
    },
    {
      ...
      description:
        "Our team creates wireframes, designs, and interactive prototypes.",
      icon: Palette,
      duration: "2-3 weeks",
    ...
    },
    {
      ...
      description:
        "Seamless deployment with monitoring and performance optimization.",
      icon: Rocket,
      duration: "1-2 weeks",
      deliverables: [
        "Live application",
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content:
        "Nexus Core delivered an exceptional mobile app that exceeded our expectations. Their attention to detail and technical expertise is outstanding.",
      rating: 5,
    ...
    },
    {
      ...
      role: "CTO",
      content:
        "The AI solution they built transformed our data processing capabilities. ROI was evident within the first quarter.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Professional, reliable, and innovative. They took our complex requirements and delivered a elegant solution.",
      rating: 5,
  ...
  const categoriesRef = useStaggeredAnimation(serviceCategories.length, {
    threshold: 0.1,
  });
  const servicesRef = useStaggeredAnimation(6, { threshold: 0.1 });
  const techRef = useStaggeredAnimation(technologies.length, {
    threshold: 0.1,
  });
  const processRef = useStaggeredAnimation(process.length, { threshold: 0.1 });
  const pricingRef = useScrollAnimation({ threshold: 0.2 });
  const testimonialsRef = useStaggeredAnimation(testimonials.length, {
    threshold: 0.1,
  });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-2">
              ...
              growth and innovation. From web applications to AI-powered
              systems, we build technology that makes a difference.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-mega text-foreground mb-4">Service Details</h2>
          ...
          >
            {filteredServices.map((service) => {
              ...
              return (
                <Card
                  key={service.name}
                  className="p-8 scroll-animate-card hover:border-primary/30 transition-all duration-300"
                >
          ...
          >
            {process.map((step) => {
              ...
              return (
                <Card
                  key={step.step}
                  className="p-6 scroll-animate-card hover:border-primary/30 transition-all duration-300"
                >
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            {metrics.map((metric, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center space-y-2 scroll-animate-card"
                >
