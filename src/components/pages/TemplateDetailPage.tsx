            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="text-center p-4 bg-card rounded-lg border border-white/10"
                  >
            ...
            <Card className="p-6 bg-card border-white/10">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground font-medium text-green-500">
                    ✓ Responsive
                  </span>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="text-center">
                    ...
                    <div className="text-muted-foreground">
                      Based on {template.reviews} reviews
                    </div>
                  </div>
                ...
                {[
                  {
                    ...
                    rating: 5,
                    comment:
                      "This template saved me weeks of development time. The code quality is exceptional and the design is clean and modern.",
                  },
                  {
                    ...
                    rating: 5,
                    comment:
                      "I've purchased many templates before, but this one stands out. Well-documented and easy to customize.",
                  },
                  {
                    name: "Emily Johnson",
                    role: "Agency Owner",
                    rating: 5,
                    comment:
                      "We use this template for client projects. It's flexible, fast, and our clients love the professional look.",
                  },
                ].map((review, index) => (
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {relatedTemplates.map((relatedTemplate) => (
                <Card
                  ...
                  onClick={() =>
                    handleRelatedTemplateSelect(relatedTemplate.id)
                  }
                >
