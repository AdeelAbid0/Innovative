...
const processSteps = [
  {
    ...
    description: "Browse our curated collection of premium templates and purchase the one that matches your vision.",
  ...
  },
  {
    ...
    description: "Select from our recommended free hosting platforms. All offer easy deployment and professional features.",
      ...
      <div className="w-full h-40 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl flex items-center justify-center relative">
        <div className="grid grid-cols-3 gap-2 w-full px-4">
          {[
            ...
            <div key={i} className={`bg-card rounded-lg p-3 text-center transition-all duration-300 ${
              platform.selected ? 'ring-2 ring-primary shadow-lg' : 'opacity-60'
            }`}>
              <div className={`w-8 h-8 ${platform.color}/20 rounded-lg mx-auto mb-2 flex items-center justify-center`}>
  ...
  },
  {
    ...
    description: "Simply drag your template files to the hosting platform. Deployment is automatic and takes seconds.",
      ...
      <div className="w-full h-40 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl flex items-center justify-center relative overflow-hidden">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-primary font-medium">Deploying...</span>
            <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    description: "Connect your custom domain or use the provided URL. Your professional website is now live for the world to see.",
        ...
        <div className="flex flex-col items-center space-y-3">
          <div className="flex items-center space-x-3">
            ...
            <div className="bg-primary/20 px-3 py-2 rounded-lg">
              <span className="text-sm font-medium text-primary">yoursite.com</span>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-xs text-green-600 font-medium">Live & Secure</span>
          </div>
        </div>
        <div className="absolute top-3 right-3">
...
const hostingPlatforms = [
  {
    ...
    features: ["Drag & drop deployment", "Automatic SSL", "Form handling", "Edge functions"],
  ...
  },
  {
    ...
    features: ["GitHub integration", "Custom domains", "HTTPS", "Jekyll support"],
...
const faqData = [
  {
    ...
    answer: "No coding knowledge required! Our templates are ready to use and come with clear instructions for customization."
  },
  {
    question: "How long does deployment take?",
    answer: "Most deployments complete in under 30 seconds. The entire process from purchase to live website takes 15-30 minutes."
  },
  {
    question: "Can I use my own domain?",
    answer: "Yes! All recommended hosting platforms support custom domains. You can connect your domain in just a few clicks."
  },
  {
    question: "Is hosting really free?",
    answer: "Yes, all recommended platforms offer generous free tiers that are perfect for personal and small business websites."
  },
  {
    question: "What if I need help?",
    answer: "We provide comprehensive documentation, video tutorials, and email support to help you every step of the way."
  },
  {
    question: "Can I customize the templates?",
    answer: "Absolutely! Templates are fully customizable. Change colors, fonts, content, and layout to match your brand."
  }
];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="space-y-6">
            <div className={`transition-all duration-800 ease-out ${
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground">
                ...
                <span className="text-primary block md:inline md:ml-3">15 Minutes</span>
              </h1>
            </div>
            
            <p className={`text-lg text-muted-foreground max-w-2xl mx-auto transition-all duration-800 delay-200 ${
              isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              Transform your vision into a live website with our simple 4-step process. 
              No coding knowledge required, no monthly fees, just professional results.
            </p>

            <div className={`flex flex-wrap items-center justify-center gap-6 text-sm transition-all duration-800 delay-400 ${
              isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              {[
                { icon: <Clock className="w-4 h-4" />, text: "15-30 minutes" },
                { icon: <Code className="w-4 h-4" />, text: "No coding required" },
                { icon: <Shield className="w-4 h-4" />, text: "Free SSL included" }
              ].map((item, i) => (
                <div key={i} className="flex items-center space-x-2 text-muted-foreground">
      ...
      <div className="max-w-6xl mx-auto px-4 space-y-20 pb-20">
        ...
        <section data-section="process" className="space-y-12">
          <div className={`text-center space-y-4 transition-all duration-700 ${
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Four simple steps to transform your idea into a professional website
            </p>
          </div>
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${
                  ...
                  <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white font-bold transition-all duration-500 ${
                        visibleSteps.has(step.id) ? 'scale-100 rotate-0' : 'scale-75 rotate-12'
                      }`}>
                        {step.id}
                      </div>
                      ...
                      {step.features.map((feature, featureIndex) => (
                        <li
                          ...
                          className={`flex items-center space-x-3 transition-all duration-500 ${
                            visibleSteps.has(step.id) ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'
                          }`}
                  ...
                  <div className={`${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                    <Card className={`p-6 transition-all duration-700 hover:shadow-lg ${
                      visibleSteps.has(step.id) 
        ...
        <section data-section="hosting" className="space-y-12">
          <div className={`text-center space-y-4 transition-all duration-700 ${
            visibleSections.has('hosting') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
            <h2 className="text-3xl font-bold text-foreground">
              Choose Your Platform
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Select from our recommended hosting platforms. All offer free plans perfect for getting started.
            </p>
          </div>
        ...
        {/* Quick Stats */}
        <section data-section="stats" className={`py-12 transition-all duration-700 ${
          ...
          <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10">
            <CardContent className="p-0">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                {[
                  { number: "15min", label: "Average Setup Time", icon: <Clock className="w-5 h-5" /> },
                  { number: "99.9%", label: "Uptime Guarantee", icon: <Shield className="w-5 h-5" /> },
                  { number: "1000+", label: "Websites Launched", icon: <Users className="w-5 h-5" /> },
                  { number: "24/7", label: "Support Available", icon: <HelpCircle className="w-5 h-5" /> }
                ].map((stat, index) => (
                  <div
                    key={index}
        ...
        {/* Final CTA */}
        <section data-section="cta" className={`text-center space-y-8 py-12 transition-all duration-700 ${
          visibleSections.has('cta') ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
        }`}>
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of users who have successfully launched their websites using our templates and proven process.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
            {[
              ...
              { icon: <CheckCircle className="w-4 h-4" />, text: "Lifetime updates" },
