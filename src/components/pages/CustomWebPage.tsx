...
const process = [
  ...
  },
  {
    ...
    description:
      "Our team designs the system architecture and creates user experience mockups.",
    icon: Layers,
  },
  {
    step: "03",
    ...
    description:
      "Agile development with continuous testing to ensure quality and reliability.",
    icon: Code,
  },
  {
    step: "04",
    ...
    description:
      "Seamless deployment with ongoing maintenance and support services.",
    icon: Settings,
  },
];
...
export function CustomWebPage({ onNavigate }: CustomWebPageProps) {
  ...
  const servicesRef = useStaggeredAnimation(services.length, {
    threshold: 0.1,
  });
        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We specialize in building robust, scalable software solutions
                    ...
                    <div className="mt-auto">
                      <div className="flex flex-wrap gap-2">
                        ...
                        {service.technologies.length > 3 && (
                          <Badge
                            variant="outline"
                            className="text-xs opacity-60 scroll-animate-badge"
                          >
                            +{service.technologies.length - 3}
                          </Badge>
                        )}
          ...
          >
            {process.map((step, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center space-y-4 scroll-animate-card"
                >
