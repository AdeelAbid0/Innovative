...
const journey = [
  {
    ...
    description:
      "Started as a small team of passionate developers with a vision to create innovative software solutions.",
    icon: Lightbulb,
  },
  {
    year: "2018",
    ...
    description:
      "Landed our first major enterprise project, establishing our reputation for delivering complex solutions.",
    icon: Briefcase,
  },
  {
    year: "2020",
    ...
    description:
      "Grew to a diverse team of 25+ developers, designers, and project managers across multiple specialties.",
    icon: Users,
  },
  {
    year: "2024",
    ...
    description:
      "Evolved into Nexus Core, focusing on cutting-edge technologies including AI, cloud solutions, and enterprise software.",
    icon: Globe,
  },
];
...
const values = [
  {
    ...
    description:
      "Every solution we build is tailored to meet our clients' specific needs and business objectives.",
  },
  {
    icon: Zap,
    title: "Innovation First",
    description:
      "We stay at the forefront of technology, continuously learning and adopting the latest tools and methodologies.",
  },
  {
    icon: Shield,
    title: "Quality & Security",
    description:
      "We never compromise on code quality, security standards, or performance optimization.",
  },
  {
    icon: Users,
    title: "Collaborative",
    description:
      "We believe in transparent communication and close collaboration with our clients throughout every project.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 space-y-20">
        ...
        >
          <div className="space-y-6">
            <Badge
              variant="outline"
              className="px-4 py-2 text-sm scroll-animate-badge"
            >
              🚀 About Nexus Core
            </Badge>
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              solutions. Since 2016, we've been helping businesses leverage
        ...
        >
          {stats.map((stat, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-4 text-center scroll-animate-card hover:shadow-lg transition-all hover-scale"
              >
          ...
          <Card className="p-6 scroll-animate-card card-premium">
            <CardContent className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                drive growth, efficiency, and competitive advantage. We bridge
            ...
            <div className="space-y-8">
              {journey.map((milestone, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start space-x-6 scroll-animate-card"
                  >
                    ...
                    <div className="flex-1 pb-8">
                      <div className="flex items-center space-x-3 mb-2">
                        <Badge
                          variant="outline"
                          className="text-xs px-2 py-1 scroll-animate-badge"
                        >
                          {milestone.year}
                        </Badge>
          ...
          >
            {values.map((value, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 scroll-animate-card hover:shadow-lg transition-all hover-scale"
                >
                  <CardContent className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A diverse group of talented professionals united by our passion
              for technology
            </p>
          </div>

          <div
            className={`grid grid-cols-2 md:grid-cols-3 gap-6 stagger-children ${
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 bg-card/50 rounded-lg p-3 scroll-animate-badge"
              >
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              business value. Our agile approach ensures rapid delivery without
