...
import { 
  ArrowLeft, Star, Calendar, Users, Building, Target, CheckCircle, 
  TrendingUp, Globe, Zap, ExternalLink, Clock, Award, Lightbulb
} from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-foreground mb-4">Case Study Not Found</h2>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Understanding the problem</p>
                  </div>
                </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">How we solved it</p>
                  </div>
                </div>
                <Card className="p-8 bg-card border border-border/50">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {caseStudy.technologies.map((tech: string, index: number) => (
                        <div key={index} className="flex items-center space-x-2 p-3 bg-muted/50 rounded-lg border border-border/30">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  {caseStudy.results.metrics.map((metric: any, index: number) => (
                    <Card key={index} className="p-6 text-center bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
                      <div className="text-3xl font-bold text-primary mb-2">{metric.value}</div>
                      <div className="text-sm font-medium text-foreground mb-1">{metric.label}</div>
                      <div className="text-xs text-muted-foreground">Within first quarter</div>
                    </Card>
                  ))}
                </div>
                ...
                <Card className="p-8 bg-gradient-to-r from-muted/50 to-muted/30 border border-border/50">
                  <div className="text-center">
                    ...
                    <div className="space-y-1">
                      <div className="font-bold text-foreground">{caseStudy.results.author}</div>
              ...
              <Card className="p-6 bg-card border border-border/50 sticky top-32">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="text-foreground font-medium">{caseStudy.industry}</div>
                  </div>
                  
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">Duration</div>
                    <div className="text-foreground font-medium">{caseStudy.timeline}</div>
                  </div>
                  
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">Team</div>
                    <div className="text-foreground font-medium">{caseStudy.teamSize}</div>
                  </div>
                </div>

                <div className="mt-8 pt-6 border-t border-border">
                  <h4 className="font-semibold text-foreground mb-3">Interested in Similar Results?</h4>
              ...
              <Card className="p-6 bg-card border border-border/50">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-primary">On Time</span>
                  </div>
                </div>
              </Card>
            </div>
