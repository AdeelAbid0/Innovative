...
const ProjectDetailView: React.FC<ProjectDetailProps> = memo(
  ({ project, onBack }) => {
    return (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {project.metrics.map((metric, index) => (
                <Card
                  key={index}
                  className="p-6 text-center bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10"
                >
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss how we can create a similar solution tailored to
