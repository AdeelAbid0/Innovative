...
import { 
  Monitor, User, Grid3x3, Briefcase, MessageCircle, BookOpen, 
  Mail, Globe, Star, ArrowRight, Menu, Search, Play, Heart,
  ShoppingCart, MapPin, Phone, Calendar, Award, Target, Users,
  Package, CreditCard, BarChart, Settings, Camera, Type, Tag,
  Edit, List, Image, DollarSign, Quote, UserPlus, TestTube,
  Link, Database, Book, Headphones, RefreshCw, Share2, Clock
} from 'lucide-react';
...
export function SectionWireframe({ sectionType, isActive = false }: WireframeProps) {
  const getWireframeContent = () => {
    // Consistent minimal styling for all wireframes
    const baseClasses = `relative w-full h-full bg-card rounded-lg overflow-hidden transition-all duration-300 ${isActive ? 'scale-105 ring-2 ring-primary/20' : ''}`;
    ...
    switch (sectionType) {
          ...
          <div className={baseClasses}>
            <div className={contentPadding}>
              ...
              <div className="text-center space-y-2">
                ...
                <div className={`w-16 h-1 ${elementBgSecondary} rounded mx-auto`}></div>
                ...
                <div className={`w-full h-6 ${elementBgSecondary} rounded mt-3 flex items-center justify-center`}>
          ...
          <div className={baseClasses}>
            <div className={contentPadding}>
              <div className="flex items-start gap-2">
                {/* Profile image */}
                <div className={`w-6 h-6 ${accentBg} rounded-full flex items-center justify-center flex-shrink-0`}>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-1 mb-2">
                    ...
                    <div className={`w-3 h-1 ${elementBgSecondary} rounded`}></div>
                    <div className={`w-4 h-1 ${elementBgSecondary} rounded`}></div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <div className="text-center">
                      ...
                      <div className={`w-3 h-0.5 ${elementBgSecondary} rounded`}></div>
                    </div>
                    <div className="text-center">
                      <div className={`w-2 h-1 ${accentBg} rounded mb-1`}></div>
                      <div className={`w-3 h-0.5 ${elementBgSecondary} rounded`}></div>
            ...
            <div className="p-3 h-full">
              ...
              <div className="grid grid-cols-3 gap-0.5">
                {[1, 2, 3, 4, 5, 6].map((item, index) => (
                  <div 
                    key={item} 
                    className={`w-full h-4 ${index < 3 ? elementBg : elementBgSecondary} rounded relative overflow-hidden`}
                  >
                    {index < 3 && (
          ...
          <div className={baseClasses}>
            <div className={contentPadding}>
              ...
              <div className="space-y-2">
                {[1, 2, 3].map((item) => (
                  <div key={item} className={`flex items-center gap-2 p-1.5 ${elementBgSecondary} rounded`}>
                    <div className={`w-3 h-3 ${accentBg} rounded flex items-center justify-center`}>
                      <Briefcase className="w-1.5 h-1.5 text-primary" />
                    </div>
                    <div className="flex-1">
                      <div className={`w-8 h-1 ${elementBg} rounded mb-0.5`}></div>
                      <div className={`w-6 h-0.5 ${elementBgSecondary} rounded`}></div>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[1, 2, 3, 4].map((member) => (
                  <div key={member} className="text-center">
                    <div className={`w-4 h-4 ${accentBg} rounded-full mx-auto mb-1 flex items-center justify-center`}>
                      <Users className="w-2 h-2 text-primary" />
                    </div>
                    <div className={`w-6 h-0.5 ${elementBg} rounded mx-auto mb-0.5`}></div>
                    <div className={`w-4 h-0.5 ${elementBgSecondary} rounded mx-auto`}></div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className={contentPadding}>
              ...
              <div className={`${elementBgSecondary} rounded p-2 mb-2`}>
                <div className="flex gap-0.5 mb-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="w-1 h-1 text-primary fill-current" />
                  ))}
                </div>
                <div className="space-y-1 mb-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div>
                    <div className={`w-6 h-0.5 ${elementBg} rounded mb-0.5`}></div>
                    <div className={`w-4 h-0.5 ${elementBgSecondary} rounded`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {[1, 2].map((post) => (
                  <div key={post} className="flex gap-2">
                    <div className={`w-4 h-4 ${accentBg} rounded flex items-center justify-center`}>
                      <BookOpen className="w-2 h-2 text-primary" />
                    </div>
                    <div className="flex-1">
                      <div className={`w-8 h-1 ${elementBg} rounded mb-0.5`}></div>
                      <div className={`w-6 h-0.5 ${elementBgSecondary} rounded mb-1`}></div>
          ...
          <div className={baseClasses}>
            <div className={contentPadding}>
              ...
              <div className="space-y-1.5">
                <div className={`w-full h-2 ${elementBgSecondary} rounded`}></div>
                <div className={`w-full h-2 ${elementBgSecondary} rounded`}></div>
                <div className={`w-full h-4 ${elementBgSecondary} rounded`}></div>
                
                {/* Submit button */}
                <div className="flex justify-end mt-2">
                  <div className={`w-6 h-2 ${accentBg} rounded flex items-center justify-center`}>
            ...
            <div className={contentPadding}>
              ...
              <div className="grid grid-cols-3 gap-2 h-full">
                ...
                <div>
                  ...
                  <div className={`w-full h-1.5 ${elementBgSecondary} rounded`}></div>
                </div>
              </div>
              
              {/* Bottom bar */}
              <div className={`absolute bottom-1 left-1 right-1 h-0.5 ${elementBgSecondary} rounded`}></div>
            </div>
          </div>
        );
          ...
          <div className={baseClasses}>
            <div className={contentPadding}>
              ...
              <div className="flex items-center justify-between mb-3">
                <div className={`w-6 h-1.5 ${accentBg} rounded`}></div>
                {sectionType.includes('Shopping') || sectionType.includes('Product') ? (
                ...
                ) : sectionType.includes('Admin') || sectionType.includes('Settings') ? (
              ...
              <div className="space-y-2">
                ...
                <div className={`w-3/4 h-1 ${elementBgSecondary} rounded`}></div>
              </div>
      ...
      default:
        return (
          <div className={baseClasses}>
            <div className={`${contentPadding} flex items-center justify-center`}>
